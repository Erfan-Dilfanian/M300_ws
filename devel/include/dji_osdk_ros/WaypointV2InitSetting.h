...
struct WaypointV2InitSetting_
{
  ...
  _gotoFirstWaypointMode_type gotoFirstWaypointMode;
   ...
   typedef std::vector< ::dji_osdk_ros::WaypointV2_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::dji_osdk_ros::WaypointV2_<ContainerAllocator> >> _mission_type;
