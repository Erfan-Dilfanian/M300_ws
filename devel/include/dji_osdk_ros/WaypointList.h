...
struct WaypointList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::dji_osdk_ros::Waypoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::dji_osdk_ros::Waypoint_<ContainerAllocator> >> _waypoint_list_type;
