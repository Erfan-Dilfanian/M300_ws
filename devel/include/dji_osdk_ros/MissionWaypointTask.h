...
struct MissionWaypointTask_
{
  ...
  _gimbal_pitch_mode_type gimbal_pitch_mode;
   ...
   typedef std::vector< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> >> _mission_waypoint_type;
