...
struct GenerateWaypointV2ActionRequest_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::dji_osdk_ros::WaypointV2Action_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::dji_osdk_ros::WaypointV2Action_<ContainerAllocator> >> _actions_type;
