...
struct GetHMSDataResponse_
{
  ...
  _deviceIndex_type deviceIndex;
   ...
   typedef std::vector< ::dji_osdk_ros::HMSPushInfo_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::dji_osdk_ros::HMSPushInfo_<ContainerAllocator> >> _errList_type;
