...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/qin/M300_ws/src/cv_bridge/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/qin/M300_ws/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/qin/M300_ws/install)
...
if(NOT "/home/qin/M300_ws/src/cv_bridge/cv_bridge/include;/usr/include/opencv4 " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/qin/M300_ws/src/cv_bridge/cv_bridge/include;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qin/M300_ws/src/cv_bridge/cv_bridge/${idir}'.  ${_report}")
    endif()
