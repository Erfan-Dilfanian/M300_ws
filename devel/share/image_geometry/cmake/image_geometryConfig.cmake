...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/erfan/Qiaomeng workspace/m300_ws/src/cv_bridge/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/erfan/Qiaomeng workspace/m300_ws/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/erfan/Qiaomeng workspace/m300_ws/install)
...
if(NOT "/home/erfan/Qiaomeng workspace/m300_ws/src/cv_bridge/image_geometry/include;/usr/include/opencv4 " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/erfan/Qiaomeng workspace/m300_ws/src/cv_bridge/image_geometry/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/erfan/Qiaomeng workspace/m300_ws/src/cv_bridge/image_geometry/${idir}'.  ${_report}")
    endif()
