...
class SingleFireRGB {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SingleFireRGB(null);
  ...
  static datatype() {
    ...
    return 'forest_fire_detection_system/SingleFireRGB';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '07b3335d23070b1b1f83844b96f60949';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SingleFireRGB(null);
