...
(cl:defclass <SingleFireIR> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass SingleFireIR (<SingleFireIR>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SingleFireIR>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SingleFireIR)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name forest_fire_detection_system-msg:<SingleFireIR> is deprecated: use forest_fire_detection_system-msg:SingleFireIR instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <SingleFireIR>))
...
(cl:defmethod img_width-val ((m <SingleFireIR>))
...
(cl:defmethod img_height-val ((m <SingleFireIR>))
...
(cl:defmethod resize_img_width-val ((m <SingleFireIR>))
...
(cl:defmethod resize_img_height-val ((m <SingleFireIR>))
...
(cl:defmethod target_type-val ((m <SingleFireIR>))
...
(cl:defmethod img_x-val ((m <SingleFireIR>))
...
(cl:defmethod img_y-val ((m <SingleFireIR>))
  ...
  (img_y m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<SingleFireIR>)))
    "Constants for message type '<SingleFireIR>"
  '((:IS_BACKGROUND . 0)
    (:IS_HEAT . 1)
    (:IS_UNKNOWN . 255))
)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SingleFireIR>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SingleFireIR>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SingleFireIR>)))
  "Returns string type for a message object of type '<SingleFireIR>"
  "forest_fire_detection_system/SingleFireIR")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SingleFireIR)))
  "Returns string type for a message object of type 'SingleFireIR"
  "forest_fire_detection_system/SingleFireIR")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SingleFireIR>)))
  "Returns md5sum for a message object of type '<SingleFireIR>"
  "9ea94f8510b24f699c5a36dcda64a4f8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SingleFireIR)))
  "Returns md5sum for a message object of type 'SingleFireIR"
  "9ea94f8510b24f699c5a36dcda64a4f8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SingleFireIR>)))
  "Returns full string definition for message of type '<SingleFireIR>"
  (cl:format cl:nil "Header header~%~%# image shape~%uint16 img_width~%uint16 img_height~%~%# reszie shape~%uint16 resize_img_width~%uint16 resize_img_height~%~%# target type~%uint8 IS_BACKGROUND = 0~%uint8 IS_HEAT = 1~%uint8 IS_UNKNOWN = 255~%~%uint8 target_type~%~%# the x and y pos (sub-pixel) of the single fire, opencv style coordinates~%float32 img_x~%float32 img_y~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SingleFireIR)))
  "Returns full string definition for message of type 'SingleFireIR"
  (cl:format cl:nil "Header header~%~%# image shape~%uint16 img_width~%uint16 img_height~%~%# reszie shape~%uint16 resize_img_width~%uint16 resize_img_height~%~%# target type~%uint8 IS_BACKGROUND = 0~%uint8 IS_HEAT = 1~%uint8 IS_UNKNOWN = 255~%~%uint8 target_type~%~%# the x and y pos (sub-pixel) of the single fire, opencv style coordinates~%float32 img_x~%float32 img_y~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SingleFireIR>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SingleFireIR>))
  "Converts a ROS message object to a list"
  (cl:list 'SingleFireIR
