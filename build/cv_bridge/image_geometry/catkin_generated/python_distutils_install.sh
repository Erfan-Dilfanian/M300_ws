...
echo_and_run cd "/home/qin/M300_ws/src/cv_bridge/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/qin/M300_ws/src/cv_bridge/image_geometry/setup.py" \
     \
    build --build-base "/home/qin/M300_ws/build/cv_bridge/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
